...
POC of stepping through a decision graph

This project requires Neo4j 2026.3.1 or higher
...
This will produce a jar-file, `target/decision_graph-1.0-SNAPSHOT.jar`,
that can be copied to the `plugin` directory of your Neo4j instance.

Update your Neo4j configuration file to include the following:
 
    dbms.security.procedures.allowlist=com.maxdemarzi.*
...
Try it:
    ...
    CALL com.maxdemarzi.decision_tree.traverse('bar entrance', {});
    CALL com.maxdemarzi.decision_tree.traverse('bar entrance', {age:'20'});
    CALL com.maxdemarzi.decision_tree.traverse('bar entrance', {age:'24'}); 
    CALL com.maxdemarzi.decision_tree.traverse('bar entrance', {gender:'male', age:'20'});
    CALL com.maxdemarzi.decision_tree.traverse('bar entrance', {gender:'female', age:'19'});
    CALL com.maxdemarzi.decision_tree.traverse('bar entrance', {gender:'male', age:'23'});     
...
Try it:
    ...
    CALL com.maxdemarzi.decision_tree.traverse('funeral', {});
    CALL com.maxdemarzi.decision_tree.traverse('funeral', {answer_1:'what'});
    CALL com.maxdemarzi.decision_tree.traverse('funeral', {answer_1:'yeah', answer_2:'yeah', answer_3:'yeah'});    
    CALL com.maxdemarzi.decision_tree.traverse('funeral', {answer_1:'what', answer_2:'', answer_3:''});    
    CALL com.maxdemarzi.decision_tree.traverse('funeral', {answer_1:'what', answer_2:'yeah', answer_3:'okay'});

Validate Parameters:

    CALL com.maxdemarzi.decision_tree.validate('age', '20');
    CALL com.maxdemarzi.decision_tree.validate('age', '-45');
    CALL com.maxdemarzi.decision_tree.validate('age', 'cat');
    CALL com.maxdemarzi.decision_tree.validate('gender', 'attack helicopter');    